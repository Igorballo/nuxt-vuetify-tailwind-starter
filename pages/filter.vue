        ...
        <div class="tw-bg-white tw-text-sm">
          ...
          <div class="tw-p-6 tw-bg-white tw-flex tw-flex-col tw-gap-6">
            <div class="tw-flex tw-gap-6">
              ...
              <div class="tw-font-semibold"><span
                class="tw-text-gray-700 tw-font-light">Prise en charge</span> <br>
                Lombok – Aéroport <br>
                déc 14 2022 <br>
                10:00 am
              </div>
            ...
            <div class="tw-flex tw-gap-6">
              ...
              <div class="tw-font-semibold"><span class="tw-text-gray-700 tw-font-light">Retour</span> <br>
                France – Paris <br>
                déc 16 2022 <br>
                8:00 am
              </div>
            ...
            <button class="tw-text-white tw-bg-blue-800 tw-font-semibold tw-rounded-lg tw-py-2 tw-px-6">Modifier
            </button>
          </div>
        </div>
      </div>
            ...
            <div class="tw-py-4 tw-flex tw-gap-12 tw-text-sm">
              <div class="tw-flex tw-flex-col tw-gap-6">
                ...
                <div class="tw-flex tw-justify-between tw-font-semibold">
                  <div title="Peut prendre 7 personnes au total" class="tw-inline-flex tw-justify-center tw-items-center tw-border-r-2 tw-gap-2 tw-w-1/3">
                    <span class="">7</span>
                  ...
                  <div title="Peut prendre 3 valises au total" class="tw-inline-flex tw-justify-center tw-items-center tw-border-r-2 tw-gap-2 tw-w-1/3">
                    <span class="">2</span>
                  ...
                  <div title="4 portes" class="tw-inline-flex tw-justify-center tw-items-center tw-border-r-2 tw-gap-2 tw-w-1/3">
                    <span class="">4</span>

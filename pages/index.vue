<template>
  <div>
<!--    <div class="tw-bg-gray-900 tw-h-full tw-h-screen"></div>-->
    <nav
      class="md:tw-left-0 md:tw-block md:tw-fixed md:tw-top-0 md:tw-bottom-0 md:tw-overflow-y-auto md:tw-flex-row md:tw-flex-nowrap md:tw-overflow-hidden tw-shadow-xl tw-bg-white tw-flex tw-flex-wrap tw-items-center tw-justify-between tw-relative md:tw-w-64 tw-z-10 tw-py-4 tw-px-4"
    >
      <div
      ...
      >
        ...
        >
          <!-- Collapse header -->
          <div
            class="md:tw-min-w-full md:tw-hidden tw-block tw-pb-4 tw-mb-4 tw-border-b tw-border-solid tw-border-blueGray-200"
          >
            <div class="tw-flex tw-flex-wrap">
              ...
              <div class="tw-w-6/12 tw-flex tw-justify-end">
                <button
                  type="button"
                  class="tw-cursor-pointer tw-text-black tw-opacity-50 md:tw-hidden tw-px-3 tw-py-1 tw-text-xl tw-leading-none tw-bg-transparent tw-rounded tw-border tw-border-solid tw-border-transparent"
                >

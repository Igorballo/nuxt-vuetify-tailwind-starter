            ...
            >
              ...
              >
                ...
                <v-btn
                  text
                  color="primary"
                  @click="$refs.menu.save(form.date_retour)"
                >
                  OK
                </v-btn>
              </v-date-picker>
...
<!--                        </div>-->
    ...
    <div class="tw-mx-auto tw-px-4 tw-my-20">
      <div class="tw-flex tw-flex-wrap tw-justify-evenly tw-gap-8">
        <div class="">
          <svg class="tw-h-12 tw-fill-current tw-text-gray-500" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 266 100">
        ...
        <div class="">
          <svg class="tw-h-8 tw-fill-current tw-text-gray-500" viewBox="0 0 2270 546"
               xmlns="http://www.w3.org/2000/svg">
            <g fill-rule="evenodd">
              <path

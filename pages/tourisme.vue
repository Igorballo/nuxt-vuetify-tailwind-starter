        ...
        <div class="tw-flex tw-flex-col tw-space-y-4 tw-mb-6">
          ...
          <div class="tw-grid md:tw-grid-cols-2 tw-gap-4">
            <div
              ...
              <span
                class="tw-absolute tw-left-6 tw-bottom-4 tw-text-lg lg:tw-text-2xl tw-font-bold tw-text-white tw-rounded tw-bg-blue-600 tw-px-6 tw-py-3">Mauritius Islande</span>
            </div>
            ...
            <div
              ...
              <img class="tw-h-full tw-w-full tw-relative tw-bg-cover tw-bg-center tw-rounded-lg"
                   ...
                   alt="">
              <span
                class="tw-absolute tw-left-6 tw-bottom-4 tw-text-lg lg:tw-text-2xl tw-font-bold tw-text-white tw-rounded tw-bg-blue-600 tw-px-6 tw-py-3">Maldives Islande</span>
            </div>
          </div>

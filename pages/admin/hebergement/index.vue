      ...
      <v-data-table no-data-text="aucune donneé" :headers="headers" :items="hotels" class="elevation-1">
        <template v-slot:top>
          <v-toolbar flat>
            ...
            <v-btn @click="$router.push('/admin/hebergement/liste-demande-hebergement')" color="primary" dark class="mx-2">
              Les Demandes
            </v-btn>
                  ...
                  <v-container>
                    <v-form ref="formBus" v-model="formHotel">
                      <div class="">
                        ...
                        <v-text-field :rules="nomRules" outlined required label="Nom de l'Hôtel"
                                      placeholder="Nom de l'Hôtel" v-model="form.nom"></v-text-field>
                        <v-text-field :rules="adresseRules" outlined required label="Adresse"
                                      placeholder="Adresse de l'Hôtel" v-model="form.adresse"></v-text-field>
                        <v-text-field :rules="villeRules" outlined required label="Ville" placeholder="Ville de l'Hôtel"
                                      v-model="form.ville"></v-text-field>
                        <v-text-field :rules="prixMinRules" outlined required label="Prix Minimum"
                                      placeholder="Le prix minimum de l'Hôtel " v-model="form.prix_min"></v-text-field>
                        <v-text-field :rules="prixMaxRules" outlined required label="Prix Maximum"
                                      placeholder="Le prix Maximum de l'Hôtel " v-model="form.prix_max"></v-text-field>
                        <v-textarea :rules="descriptionRules" outlined required label="Description"
                                    placeholder="Description" v-model="form.description"></v-textarea>
                        <v-text-field :rules="nombreEtoileRules" outlined required label="Le Nombre d'Etoile"
                                      placeholder="Le nombre d'Etoile" v-model="form.nombre_etoile"></v-text-field>

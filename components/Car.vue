      ...
      <div class="tw-px-6 lg:tw-px-20 tw-gap-8 tw-flex tw-flex-col">
        <div class="tw-flex tw-flex-col lg:tw-flex-row tw-gap-4">
          ...
          <div
            ...
            <span class="tw-text-xl tw-inline-flex tw-items-center tw-gap-3 tw-font-bold tw-px-4 tw-py-4 tw-italic ">
              <img class="tw-h-10 tw-w-10" src="../assets/svg/car1.svg"> À partir de € 47,02 par jour
            </span>

    ...
    <div aria-label="Site Footer" class="tw-bg-green-500">
      <div class="tw-max-w-screen-xl tw-px-4 tw-py-16 tw-mx-auto sm:tw-px-6 lg:tw-px-8">
        <div class="lg:tw-flex lg:tw-items-start lg:tw-gap-8">
          ...
          <div
            class="tw-grid tw-grid-cols-2 tw-gap-8 tw-mt-8 lg:tw-mt-0 lg:tw-grid-cols-5 lg:tw-gap-y-16"
          >
            ...
            <div class="tw-col-span-2 lg:tw-col-span-3 lg:tw-flex lg:tw-items-end">
              <form class="tw-w-full">
                <label for="UserEmail" class="tw-sr-only"> Email </label>

                <div
                  class="tw-p-2 tw-border tw-border-gray-100 focus-within:tw-ring sm:tw-flex sm:tw-items-center sm:tw-gap-4"
                >
                  <input
                    type="email"
                    id="UserEmail"
                  ...
                  <button
                    class="tw-w-full tw-px-6 tw-py-3 tw-mt-1 tw-text-sm tw-font-bold tw-tracking-wide tw-text-white tw-uppercase tw-transition-none tw-bg-teal-500 hover:tw-bg-teal-600 sm:tw-mt-0 sm:tw-w-auto sm:tw-flex-shrink-0"
                  >
                    S'inscrire
                  </button>
                </div>
            ...
            <ul
              class="tw-flex tw-justify-start tw-col-span-2 tw-gap-6 lg:tw-col-span-5 lg:tw-justify-end"
            >
              <li>
                <a
                  href="/"
                  rel="noreferrer"
                  target="_blank"
                  class="tw-text-gray-700 tw-transition hover:tw-opacity-75"
                >
